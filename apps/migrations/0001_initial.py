    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('Eligible', 'Eligible'), ('En Attente', 'Attente'), ('Ineligible', 'Ineligible')], default=('En Attente', 'Attente'), max_length=50, null=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('typ', models.CharField(choices=[('GR', 'Globules Rouges'), ('PFC', 'Plasma Frais Congelé'), ('CPS', 'Concentré Plaquettaire Standard')], max_length=50, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('serial', models.CharField(max_length=50, unique=True)),
                ('typ', models.CharField(choices=[('GR', 'Globules Rouges'), ('PFC', 'Plasma Frais Congelé'), ('CPS', 'Concentré Plaquettaire Standard')], max_length=50)),
                ('volume', models.IntegerField()),
                ('duration', models.IntegerField(blank=True, null=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('blood', models.ManyToManyField(to='apps.blood')),
                ('price', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.price')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('psl', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.psl')),
            ],
        ),
        migrations.CreateModel(
            name='Blood_analysis',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('result', models.CharField(choices=[('Sain', 'Sain'), ('Contaminé', 'Contaminé')], max_length=50)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
        ...
        migrations.AddField(
            model_name='analysis',
            name='reactant',
            field=models.ManyToManyField(to='apps.reactant'),
        ),
        migrations.CreateModel(
            name='Users',
            fields=[

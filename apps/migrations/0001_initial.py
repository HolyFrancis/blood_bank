...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('En Attente', 'En Attente'), ('Confirmée', 'Confirmée'), ('Délivrée', 'Délivrée'), ('Annulée', 'Annulée')], default=('En Attente', 'En Attente'), max_length=50)),

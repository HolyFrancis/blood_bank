    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('Eligible', 'Eligible'), ('Attente', 'En Attente'), ('Ineligible', 'Ineligible')],
                                            default=('Attente', 'En Attente'), max_length=50, null=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('En Attente', 'En Attente'), ('Confirmée', 'Confirmée'), ('Délivrée', 'Délivrée'),
                                                     ('Annulée', 'Annulée')], default=('En Attente', 'En Attente'), max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anti_hlv2_test', models.CharField(choices=[('Positif', 'Positif'), ('Négatif', 'Négatif')], max_length=50)),
                ('malaria_test', models.CharField(choices=[('Positif', 'Positif'), ('Négatif', 'Négatif')], max_length=50)),
                ('result', models.CharField(choices=[('Positif', 'Positif'), ('Négatif', 'Négatif')], default=('Positif', 'Positif'), max_length=50)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('blood', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.blood')),
            ],
